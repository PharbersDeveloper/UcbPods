...
type TargetAssignsResult struct {
	ID               string        `json:"-"`
...
func (c TargetAssignsResult) GetID() string {
	return c.ID
}

func (c TargetAssignsResult) SetID(id string) error {
	c.ID = id
	return nil
}

func (c TargetAssignsResult) GetReferences() []jsonapi.Reference {
...
func (c TargetAssignsResult) GetReferencedIDs() []jsonapi.ReferenceID {
...
func (u *TargetAssignsResult) SetToOneReferenceID(name, ID string) error {
	if name == "levelConfig" {
		u.LevelConfigID = ID
		return nil
	}
...
func (c TargetAssignsResult) GetReferencedStructs() []jsonapi.MarshalIdentifier {
...
func (c *TargetAssignsResult) SetToManyReferenceIDs(name string, IDs []string) error {
...
func (c *TargetAssignsResult) AddToManyIDs(name string, IDs []string) error {
	if name == "assessmentReportDescribes" {
...
func (c *TargetAssignsResult) GetConditionsBsonM(parameters map[string][]string) bson.M {

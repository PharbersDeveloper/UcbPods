...
func (c ManageTimeResult) GetID() string {
	return c.ID
}

func (c ManageTimeResult) SetID(id string) error {
	c.ID = id
	return nil
}

func (c ManageTimeResult) GetReferences() []jsonapi.Reference {
...
func (c ManageTimeResult) GetReferencedIDs() []jsonapi.ReferenceID {
...
func (u *ManageTimeResult) SetToOneReferenceID(name, ID string) error {
	if name == "levelConfig" {
		u.LevelConfigID = ID
		return nil
	}
...
func (c ManageTimeResult) GetReferencedStructs() []jsonapi.MarshalIdentifier {
...
func (c *ManageTimeResult) SetToManyReferenceIDs(name string, IDs []string) error {
...
func (c *ManageTimeResult) AddToManyIDs(name string, IDs []string) error {
	if name == "assessmentReportDescribes" {
...
func (c *ManageTimeResult) GetConditionsBsonM(parameters map[string][]string) bson.M {

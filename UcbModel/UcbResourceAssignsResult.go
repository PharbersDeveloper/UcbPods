...
type ResourceAssignsResult struct {
	ID               string        `json:"-"`
...
func (c ResourceAssignsResult) GetID() string {
	return c.ID
}

func (c ResourceAssignsResult) SetID(id string) error {
	c.ID = id
	return nil
}

func (c ResourceAssignsResult) GetReferences() []jsonapi.Reference {
...
func (c ResourceAssignsResult) GetReferencedIDs() []jsonapi.ReferenceID {
...
func (u *ResourceAssignsResult) SetToOneReferenceID(name, ID string) error {
	if name == "levelConfig" {
		u.LevelConfigID = ID
		return nil
	}
...
func (c ResourceAssignsResult) GetReferencedStructs() []jsonapi.MarshalIdentifier {
...
func (c *ResourceAssignsResult) GetConditionsBsonM(parameters map[string][]string) bson.M {
